...
<p align="center">
  <img src="public/diadoc-logo.png" alt="DiaDoc Logo" width="150">
</p>

<p align="center">
  <b>Интеллектуальная AI-система для комплексного контроля диабета</b>
</p>
...
<p align="center">
  ...
  <a href="#-структура-проекта"><strong>Структура</strong></a> •
  <a href="#-стратегия-развития"><strong>Развитие</strong></a>
</p>

<p align="center">
  <a href="https://github.com/Danchouvzv/DiaDoc/actions"><img src="https://img.shields.io/badge/build-passing-brightgreen" alt="Build Status"></a>
  ...
  <a href="https://github.com/Danchouvzv/DiaDoc/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue" alt="License"></a>
...
Добавлен новый модуль для экспорта и анализа данных о здоровье в различных форматах:

#### Форматы экспорта:
- **PDF отчеты**: Подробные отчеты с графиками и анализом
- **CSV файлы**: Для анализа в Excel или других программах
- **JSON данные**: Для разработчиков и интеграции с другими системами
...
├── app/
│   ├── dashboard/
│   │   └── reports/           # Страница экспорта данных
│   │       └── page.tsx
│   └── api/
│       └── exports/           # API эндпоинты для экспорта
│           ├── csv/
│           ├── json/
│           └── pdf/
├── components/
│   └── ui/
│       └── date-range-picker.tsx  # Компонент выбора дат
└── lib/
...
#### Как использовать:
1. Перейдите в раздел "Reports & Export" в дашборде
...
4. Выберите формат экспорта (PDF/CSV/JSON)
5. Нажмите "Export Data"

#### Особенности:
- Интерактивные PDF отчеты с графиками
